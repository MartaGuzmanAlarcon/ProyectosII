...
data = readmatrix('/Users/martaguzman/3_Carrera/3S2/ProyectosII/PruebasDistintosRegistros/20240301_Escaleras_ecg_stream.csv');
% Extraer las columnas correspondientes a las aceleraciones x, y, y z
ecg_movesense = data(:, 2); 
...
nombre_archivo = 'MoveSenseResultados_geometricMean_vector.csv';
